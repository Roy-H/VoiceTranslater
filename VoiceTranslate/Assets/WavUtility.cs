...
public class WavUtility
{
    ...
    private static string lastAutioFileName = string.Empty;
    ...
    public static byte[] FromAudioClip(AudioClip audioClip, out string filepath, bool saveAsFile = true, string dirname = "recordings")
    {
        ...
        if (saveAsFile)
        {
            ...
            //filepath = string.Format("{0}/{1}/{2}.{3}", "D:/", dirname, "temp", "wav");
            ...
            if (lastAutioFileName != string.Empty)
            {
                File.Delete(lastAutioFileName);
            }
            lastAutioFileName = filepath;
